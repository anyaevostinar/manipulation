...
class ParasiteChromosome(Chromosome):
    """ A chromosome for parasitic recurrent neural networks. """
    _id = 0
    def __init__(self, parent1_id, parent2_id, node_gene_type, conn_gene_type):

        self._id = self.__get_new_id()
        
        #Should the parasite get any input at all?
        self._input_nodes  = Config.input_nodes
        
        #How many nodes of the host should the parasite be able to manipulate?
