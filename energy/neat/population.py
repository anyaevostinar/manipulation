...
import species
import host_chromosome
import parasite_chromosome
...
class Population(object):
    ...
    def __init__(self, checkpoint_file=None):
        ...
        if checkpoint_file:
            ...
            #inject some parasites!
            self.__inject_parasites()
        else:
    ...
    def __create_population(self):
        ...
        if Config.feedforward:
            genotypes = host_chromosome.FFChromosome
        else:
            genotypes = host_chromosome.HostChromosome
    ...
    def __inject_parasites(self):
        #Give every host a parasite
        print "Injecting some parasites!\n"
        genotypes = parasite_chromosome.ParasiteChromosome
        ...
        for i in xrange(self.__popsize):
            ...
            if Config.hidden_nodes > 0:
                g.add_hidden_nodes(Config.hidden_nodes)
            self.__population[i].parasite_chrom = g
    
        print "Last parasite injected: ", self.__population[-1].parasite_chrom, "\n"
